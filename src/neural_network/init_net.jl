"""
get_mlp((input_size, output_size), hidden_layers, hidden_width, activation, net_struct, rng)

Construct an MLP, initialize parameters/state, and return `(model, ps, st)`.
"""
...
"""
get_node((input_size, output_size), hidden_layers, hidden_width, activation, net_struct, solver, rng)

Construct a neural-ODE model, initialize parameters/state, and return `(model, ps, st)`.
"""
...
# end
# Network initialization and parameter setup utilities.
